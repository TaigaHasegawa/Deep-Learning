...
def caption_image_beam_search(encoder, decoder, image_path, word_map, beam_size=20):
    """
...
if __name__ == '__main__':
    ...
    parser.add_argument('--beam_size',  default=20, type=int, help='beam size for beam search')

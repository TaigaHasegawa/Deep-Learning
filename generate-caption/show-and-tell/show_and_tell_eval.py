...
checkpoint = 'BEST_checkpoint_flickr30k_5_cap_per_img_5_min_word_freqwith_res152.pth.tar'  # model checkpoint
word_map_file = '../caption_datasets/WORDMAP_flickr30k_5_cap_per_img_5_min_word_freq.json'  # word map, ensure it's the same the data was encoded with and the model was trained with
...
def evaluate(beam_size):
    ...
    #calculate BLUE-1 scores
    weights = (1.0/1.0, )
    blue1=corpus_bleu(references, hypotheses, weights)

    return bleu4,blue1

blue4,blue1=evaluate(20)

print(checkpoint['epoch'],blue4,":",blue1)
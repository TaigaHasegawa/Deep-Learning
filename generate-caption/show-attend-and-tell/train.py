...
from models import Encoder, Decoder_with_attention
...
#pretrained_embeddings,emb_dim=load_embeddings("../NLP/glove.840B.300d.txt",word_map)
...
checkpoint="checkpoint_flickr30k_5_cap_per_img_5_min_word_freqwith_res152.pth.tar"
